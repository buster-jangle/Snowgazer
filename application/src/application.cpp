...
int main(int argc, char *argv[]){
    ////Set CLI defaults
    std::string logfilePath = "logs/Snowgazer.log"; // Default logfile path
    ...
    CLI::App cli{"-Snowgazer application description-"};
    cli.add_option("-l,--logfile", logfilePath, "Logfile destination. Default: ./logs/Snowgazer.log");
